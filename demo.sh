#!/usr/bin/env bash
# One-command reproduction of the legacy core checks. Needs Rust (stable). Stage 6 (real on-chain compute
...
hr "2/6  Realistic servicer loan tapes (CSV in, native decision model out)"
...
hr "3/6  Zero-knowledge proof: coverage + all-KYC + bound to a public commitment"
cargo run --release --quiet --bin prove

hr "4/6  Native decision model (Solana alt_bn128 + ed25519) and swap-book attack"
